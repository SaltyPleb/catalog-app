      ...
      <div className="about_container">
        ...
        <div className="about_section">
          ...
          <li>
            ...
            because the market is too large, and no one wants to follow a large
            number of links, and this is how the idea appeared.
          </li>
          <li>
            We will collect for you all the components you need and you will see
            them in one place
          </li>
          <li>
